# Generated by Django 3.2.4 on 2021-06-21 22:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter a book genre (e.g. Non-Fiction, Fiction etc.)', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Reader',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reader_name', models.CharField(blank=True, default='anonymous', max_length=100, null=True)),
